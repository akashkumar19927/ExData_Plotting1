...
png("plot4.png")
par(mfrow = c(2, 2)) 
plot(datetime2, globalActivePower, type="l", xlab="", ylab="Global Active Power", cex=0.2)
...
plot(datetime2, globalReactivePower, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()